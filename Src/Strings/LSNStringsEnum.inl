...
// Menu.
LSN_STR( LSN_STR_FILE, "&File", "ファイル(&F)", "&Fichier", "&Archivo", "文件(&F)" )
LSN_STR( LSN_STR_OPTIONS, "&Options", "オプション(&O)", "&Options", "&Opciones", "选项(&O)" )
LSN_STR( LSN_STR_GAME, "&Game", "ゲーム(&G)", "&Jeu", "&Juego", "游戏(&G)" )
LSN_STR( LSN_STR_TOOLS, "&Tools", "ツール(&T)", "&Outils", "&Herramientas", "工具(&T)" )
LSN_STR( LSN_STR_HELP, "&Help", "ヘルプ(&H)", "&Aide", "A&yuda", "帮助(&H)" )
